...
public class BahanYangDibutuhkanRotiManis extends AdonanRotiManis {
    BanyakRotiPerAdonanRotiManis banyakRoti = new BanyakRotiPerAdonanRotiManis();
    public double tepungTerigu() {
        return super.tepungTerigu() / banyakRoti.hitungJumlahRotiPerAdonanRotiManis();
    }

    public double gulaPasir() {
        return super.gulaPasir() / banyakRoti.hitungJumlahRotiPerAdonanRotiManis();
    }

    public double butter() {
        return super.butter() / banyakRoti.hitungJumlahRotiPerAdonanRotiManis();
    }

    public double ragi() {
        return super.ragi() / banyakRoti.hitungJumlahRotiPerAdonanRotiManis();
    }

    public double susuBubuk() {
        return super.susuBubuk() / banyakRoti.hitungJumlahRotiPerAdonanRotiManis();
    }

    public double susuCair() {
        return super.susuCair() / banyakRoti.hitungJumlahRotiPerAdonanRotiManis();
    }

    public double telur() {
        return super.telur() / banyakRoti.hitungJumlahRotiPerAdonanRotiManis();
    }

    public double esBatu() {
        return super.esBatu() / banyakRoti.hitungJumlahRotiPerAdonanRotiManis();
    }
